...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Zenith Dashboard'); ?></title>
...
<body>
    ...
    <div class="admin-topbar d-md-none" style="position:fixed;top:10px;left:10px;right:10px;z-index:1200;display:flex;align-items:center;justify-content:space-between;background:#fff;padding:10px 14px;border-radius:12px;box-shadow:0 6px 18px rgba(2,6,23,0.06);border:1px solid rgba(226,232,240,0.6);">
        ...
        <div style="display:flex;align-items:center;gap:10px;">
            <form action="<?php echo e(route('logout')); ?>" method="POST" style="margin:0;" data-no-loading>
                <?php echo csrf_field(); ?>
    ...
    <aside class="sidebar">
        ...
        <nav class="nav-menu">
            ...
            <a href="<?php echo e(route('admin.aspirasi.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.aspirasi.*') ? 'active' : ''); ?>">
        ...
        <div class="user-widget">
            <div class="d-flex align-items-center gap-3">
                <div class="avatar-circle"><?php echo e(substr(session('full_name') ?? 'A', 0, 1)); ?></div>
                <div style="overflow: hidden;">
                    <div style="font-size: 14px; font-weight: 700; color: var(--accent-zenith); white-space: nowrap; text-overflow: ellipsis; overflow: hidden;">
                        <?php echo e(session('full_name') ?? 'Super Admin'); ?>

                    </div>
                    <div style="font-size: 10px; color: var(--text-muted); font-weight: 600;">Root Access</div>
                </div>
            </div>
            <form action="<?php echo e(route('logout')); ?>" method="POST" data-no-loading>
                <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\asp\web\resources\views/layouts/admin-dashboard.blade.php ENDPATH**/ ?>