...
<div class="flash-wrapper">
    <div id="zenithToast" class="flash-toast">
        ...
        <div>
            ...
            <p style="font-size: 0.8rem; color: var(--text-slate);"><?php echo e(session('success')); ?></p>
        </div>
    </div>
</div>
<?php endif; ?>
    ...
    <div style="display: flex; align-items: center; gap: 12px;">
        <div class="user-profile-wrapper">
            <div style="text-align: right; line-height: 1.2;">
                <p style="font-weight: 800; font-size: 0.85rem;"><?php echo e(session('full_name')); ?></p>
                <p style="font-size: 0.65rem; color: var(--ocean-primary); font-weight: 700; text-transform: uppercase;"><?php echo e(session('kelas') ?? 'SISWA'); ?></p>
            </div>
            <div class="avatar-circle"><?php echo e(strtoupper(substr(session('full_name'), 0, 1))); ?></div>
        </div>
...
<div class="container">
    <div class="stats-matrix">
        <div class="matrix-card">
            ...
            <div class="matrix-value" data-target="<?php echo e(count($aspirasi)); ?>">0</div>
        ...
        <div class="matrix-card" style="border-bottom: 4px solid var(--danger);">
            ...
            <div class="matrix-value" style="color: var(--danger);" data-target="<?php echo e($aspirasi->where('status', 'Baru')->count()); ?>">0</div>
        </div>
        <div class="matrix-card" style="border-bottom: 4px solid var(--ocean-primary);">
            ...
            <div class="matrix-value" style="color: var(--ocean-primary);" data-target="<?php echo e($aspirasi->where('status', 'Diproses')->count()); ?>">0</div>
        </div>
        <div class="matrix-card" style="border-bottom: 4px solid var(--success);">
            ...
            <div class="matrix-value" style="color: var(--success);" data-target="<?php echo e($aspirasi->where('status', 'Selesai')->count()); ?>">0</div>
        </div>
        <div class="matrix-card" style="border-bottom: 4px solid var(--warning);">
            ...
            <div class="matrix-value" style="color: var(--warning);" data-target="<?php echo e($aspirasi->where('status', 'Ditolak')->count()); ?>">0</div>
        </div>
    </div>
    ...
    <div class="terminal-window">
        <table class="zenith-table">
            ...
            <tbody>
                ...
                <tr>
                    <td style="font-family: 'Outfit';">#<?php echo e($item->id_aspirasi); ?></td>
                    <td><b style="color: var(--ocean-primary)"><?php echo e($item->nama_kategori); ?></b></td>
                    <td style="color: var(--text-slate)"><?php echo e(Str::limit($item->keterangan, 45)); ?></td>
                    <td>
                        <?php $st = strtolower($item->status); ?>
                        <span class="status-pill status-<?php echo e($st); ?>"><?php echo e(ucfirst($item->status)); ?></span>
                    </td>
                    <td style="text-align: right;">
                        <div style="display: flex; gap: 10px; justify-content: flex-end;">
                            <a href="<?php echo e(route('siswa.aspirasi.show', $item->id_aspirasi)); ?>" class="btn-action"><i class="fa-solid fa-eye"></i></a>
                            <?php if($st == 'baru'): ?>
                            <a href="<?php echo e(route('siswa.aspirasi.edit', $item->id_aspirasi)); ?>" class="btn-action" style="color: var(--success)"><i class="fa-solid fa-pen-to-square"></i></a>
                            <button onclick="openDeleteModal('<?php echo e(route('siswa.aspirasi.destroy', $item->id_aspirasi)); ?>')" class="btn-action" style="color: var(--danger)"><i class="fa-solid fa-trash"></i></button>
                            <?php endif; ?>
                        </div>
                    </td>
                </tr>
...
</html><?php /**PATH C:\asp\web\resources\views/siswa/dashboard.blade.php ENDPATH**/ ?>