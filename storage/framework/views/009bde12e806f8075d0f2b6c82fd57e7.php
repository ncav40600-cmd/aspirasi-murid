...
<body>
    ...
    <div class="container">
        <div class="header-max">
            ...
            <div class="nav-buttons">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="btn-crystal">
        ...
        <div class="glass-panel-max">
            <div class="panel-header">
                ...
                <div class="controls">
                    <form method="GET" action="<?php echo e(route('admin.aspirasi')); ?>" id="filterForm">
                        <input type="text" name="search" id="searchInput" class="input-max search-input" placeholder="Cari nama, NIS, atau kategori..." value="<?php echo e(request('search')); ?>">
                        ...
                        <select name="tahun" class="input-max" onchange="document.getElementById('filterForm').submit()">
                            ...
                            <?php for($year = $currentYear; $year >= 2020; $year--): ?>
                                <option value="<?php echo e($year); ?>" <?php echo e((request('tahun') ?: $currentYear) == $year ? 'selected' : ''); ?>><?php echo e($year); ?></option>
                            <?php endfor; ?>
                        </select>
                        
                        <select name="bulan" class="input-max" onchange="document.getElementById('filterForm').submit()">
                            <option value="">Semua Bulan</option>
                            <?php $currentMonth = date('n'); $selectedMonth = request('bulan') ?: (request('tahun') ? 0 : $currentMonth); ?>
                            <option value="1" <?php echo e($selectedMonth == '1' ? 'selected' : ''); ?>>Januari</option>
                            <option value="2" <?php echo e($selectedMonth == '2' ? 'selected' : ''); ?>>Februari</option>
                            <option value="3" <?php echo e($selectedMonth == '3' ? 'selected' : ''); ?>>Maret</option>
                            <option value="4" <?php echo e($selectedMonth == '4' ? 'selected' : ''); ?>>April</option>
                            <option value="5" <?php echo e($selectedMonth == '5' ? 'selected' : ''); ?>>Mei</option>
                            <option value="6" <?php echo e($selectedMonth == '6' ? 'selected' : ''); ?>>Juni</option>
                            <option value="7" <?php echo e($selectedMonth == '7' ? 'selected' : ''); ?>>Juli</option>
                            <option value="8" <?php echo e($selectedMonth == '8' ? 'selected' : ''); ?>>Agustus</option>
                            <option value="9" <?php echo e($selectedMonth == '9' ? 'selected' : ''); ?>>September</option>
                            <option value="10" <?php echo e($selectedMonth == '10' ? 'selected' : ''); ?>>Oktober</option>
                            <option value="11" <?php echo e($selectedMonth == '11' ? 'selected' : ''); ?>>November</option>
                            <option value="12" <?php echo e($selectedMonth == '12' ? 'selected' : ''); ?>>Desember</option>
                        </select>
                        
                        <input type="text" name="tanggal" id="dateFilter" class="input-max" placeholder="YYYY-MM-DD" value="<?php echo e(request('tanggal')); ?>" onchange="validateAndFilterDate(this)" title="Format: YYYY-MM-DD (misal: 2026-03-15)">
            ...
            <div class="table-container">
                <table class="table-max">
                    ...
                    <tbody id="tableBody">
                        ...
                        <tr>
                            <td><span class="id-cell">#<?php echo e($item->id_aspirasi); ?></span></td>
                            <td style="font-weight: 800; color: var(--text-deep);"><?php echo e($item->display_name ?? $item->full_name); ?></td>
                            <td style="font-weight: 600; color: var(--text-sub); font-family: monospace;"><?php echo e($item->display_nis ?? $item->nis); ?></td>
                            <td><span style="font-weight: 700; color: var(--aurora-indigo);"><?php echo e($item->nama_kategori); ?></span></td>
                            <td><div class="desc-cell" title="<?php echo e($item->keterangan); ?>"><?php echo e($item->keterangan); ?></div></td>
                            <td style="font-weight: 600; white-space: nowrap;"><?php echo e(\Carbon\Carbon::parse($item->created_at)->format('d M Y H:i')); ?></td>
                            <td style="font-weight: 600;"><?php echo e($item->lokasi); ?></td>
                            <td>
                                <?php
                                ...
                                ?>
                                <span class="badge-max <?php echo e($statusClass); ?>"><?php echo e(strtoupper($item->status)); ?></span>
                            </td>
                        </tr>
    ...
    <script>
        function resetFilters() {
            window.location.href = '<?php echo e(route("admin.aspirasi")); ?>';
        }
...
</html><?php /**PATH C:\asp\web\resources\views/admin/aspirasi.blade.php ENDPATH**/ ?>