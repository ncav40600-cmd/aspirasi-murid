                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; background-color: #ffffff; border-radius: 24px; overflow: hidden; box-shadow: 0 10px 15px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <?php if(isset($alasanTolak) && trim($alasanTolak) != ''): ?>
                            <div style="margin-top: 24px; padding: 20px; background-color: #fef2f2; border-radius: 16px; border-left: 5px solid #ef4444;">
                                ...
                                <p style="margin: 0; color: #b91c1c; font-size: 15px; font-style: italic; line-height: 1.5;">"<?php echo e($alasanTolak); ?>"</p>
                            </div>
                            <?php endif; ?>
...
</html><?php /**PATH C:\asp\web\resources\views/emails/aspirasi-ditolak.blade.php ENDPATH**/ ?>