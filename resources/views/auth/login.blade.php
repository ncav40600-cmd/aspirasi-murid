    ...
    <style>
        ...
        * {
        ...
        .viewport-bg {
            ...
            inset: 0;
            z-index: -2;
            background: url('{{ asset("images/newdesain.jpg") }}') center/cover no-repeat;
...
<body>
            ...
            <form action="{{ route('login') }}" method="POST">
                ...
                <div class="input-group">
                    ...
                    <div class="input-field">
                        <input type="text" name="login" value="{{ old('login') }}" placeholder="Masukkan NIS untuk siswa atau username admin..." required>
                    </div>
                </div>
    ...
    @if(session('login_error') || $errors->any())
        <script>
            const loginErrorText = @json(session('login_error') ?? $errors->first());
            if (loginErrorText) {
