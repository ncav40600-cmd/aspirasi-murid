...
<head>
    ...
    <title>@yield('title', 'Aspirasi School')</title>
...
<body>
            ...
            <div class="dropdown">
                <div class="identity-orbital" data-bs-toggle="dropdown" aria-expanded="false">
                    <div class="user-details text-end d-none d-md-block">
                        <div class="fw-800" style="font-size: 0.75rem; line-height: 1; color: var(--zenith-obsidian);">{{ session('full_name') }}</div>
                        <div style="font-size: 0.6rem; color: var(--zenith-accent); font-weight: 700; text-transform: uppercase; margin-top: 2px;">{{ session('role') }}</div>
                    </div>
                    <img src="https://ui-avatars.com/api/?name={{ urlencode(session('full_name')) }}&background=6366f1&color=fff&bold=true" class="avatar-mono">
                </div>
    ...
    <footer>
        <div class="container text-center">
            ...
            <p class="small text-muted mt-2">&copy; {{ date('Y') }} Zenith Design. Smooth Interface.</p>
        </div>
    </footer>
