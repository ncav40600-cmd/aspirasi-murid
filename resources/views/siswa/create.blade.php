...
@section('title', 'Zenith - Ajukan Aspirasi')
...
<div class="container">
    ...
    <div class="master-form-canvas">
        ...
        {{-- Penambahan enctype="multipart/form-data" wajib untuk upload file --}}
        <form action="{{ route('siswa.aspirasi.store') }}" method="POST" enctype="multipart/form-data" data-no-loading>
            @csrf
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group-spatial">
                        ...
                        <select name="id_kategori" class="spatial-input @error('id_kategori') is-invalid @enderror" required>
                ...
                <div class="col-md-6">
                    <div class="form-group-spatial">
                        ...
                        <input type="text" name="lokasi" class="spatial-input @error('lokasi') is-invalid @enderror" 
                               value="{{ old('lokasi') }}" placeholder="Contoh: Lab Komputer 1" required>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group-spatial" id="emailGroup">
                ...
                <input type="email" name="email_siswa" id="emailSiswa" class="spatial-input @error('email_siswa') is-invalid @enderror" 
                       value="{{ old('email_siswa', $user->email ?? '') }}" placeholder="nama@domain.com">
            ...
            <div class="form-group-spatial">
                ...
                <div class="spatial-file-wrapper">
                    <input type="file" name="foto" id="fotoInput" class="spatial-file-input @error('foto') is-invalid @enderror" accept="image/*">
                    ...
                    {{-- Thumbnail Preview (hidden until file selected) --}}
            ...
            <div class="form-group-spatial">
                ...
                <textarea name="keterangan" class="spatial-input @error('keterangan') is-invalid @enderror" 
                          rows="5" placeholder="Deskripsikan perubahan yang Anda inginkan secara sistematis..." required>{{ old('keterangan') }}</textarea>
            </div>

            <div class="terminal-actions">
                <a href="{{ route('siswa.dashboard') }}" class="btn-pinnacle-back">
            ...
            {{-- Legend status agar siswa tahu nama progres (kembalikan seperti sebelumnya) --}}
...
{{-- Modal preview foto (dibuka saat thumbnail diklik) --}}
